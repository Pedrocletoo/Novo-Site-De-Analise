...
import { HorasPagantesProvider } from './contexts/HorasPagantesContext';
import { SelectedResultsProvider } from './contexts/SelectedResultsContext';
  ...
  return (
    <ThemeProvider>
      <CacheProvider>
        <WebSocketProvider>
          <FilterProvider>
            <HorasPagantesProvider>
              <SelectedResultsProvider>
                <Router>
                  <MainContainer>
                    <Sidebar />
                    <ContentArea>
