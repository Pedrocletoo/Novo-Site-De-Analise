...
export const CACHE_CONFIG = {
  DEFAULT_TTL: 60000, // 60 segundos padrão (aumentado)
  LEAGUES: {
    'euro': 30000,           // 30 segundos para Euro League (aumentado)
    'campeonato-italiano': 30000, // 30 segundos para Campeonato Italiano (aumentado)
    'taca-gloria-eterna': 30000,  // 30 segundos para Taça Glória Eterna (aumentado)
  }
};
