...
export const WORKER_CONFIG = {
  POLLING_INTERVALS: {
    'euro': 5000,               // 5 segundos para Euro League (aumentado para reduzir carga)
    'campeonato-italiano': 5000, // 5 segundos para Campeonato Italiano
    'taca-gloria-eterna': 5000,  // 5 segundos para Taça Glória Eterna
    'default': 7000              // 7 segundos para outras ligas
  },
