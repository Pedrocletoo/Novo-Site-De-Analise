...
export const HalfTimeScore = styled.span`
  font-size: 12px;
  font-weight: 600;
  opacity: 0.85;
  display: block;
...
export const OddValue = styled.span<{ isUnsupported?: boolean }>`
  display: block;
  font-size: 10px;
  margin-top: 2px;
  opacity: 0.8;
  font-weight: 400;
  color: ${props => props.isUnsupported ? 'rgba(255, 255, 255, 0.5)' : 'white'};
`;
