    ...
    <TableContainer>
      ...
      {loading && !isBackgroundRefreshing && matches.length === 0 ? (
        ...
        <>
          ...
          <StatusBar>
            {isLiveConnection && <LiveIndicator>LIVE</LiveIndicator>}
            {isBackgroundRefreshing && <small>Atualizando...</small>}
            {showUpdateIndicator && <small className="update-indicator">Dados atualizados!</small>}
            {lastUpdated && (
