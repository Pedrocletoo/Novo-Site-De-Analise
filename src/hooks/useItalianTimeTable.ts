 ...
 */
const ITALIAN_MINUTE_BLOCKS = [2, 5, 8, 11, 14, 17, 20, 23, 26, 29, 32, 35, 38, 41, 44, 47, 50, 53, 56, 59];
 ...
 */
export function useItalianTimeTable(matches: IMatch[] = [], testMode = false, testHour?: number, selectedHours?: number[]): ITimeTable {
  return useMemo(() => {
