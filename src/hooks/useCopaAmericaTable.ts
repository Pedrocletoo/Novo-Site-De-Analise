 ...
 */
const FIXED_MINUTE_BLOCKS_COPA_AMERICA = [2, 5, 8, 11, 14, 17, 20, 23, 26, 29, 32, 35, 38, 41, 44, 47, 50, 53, 56, 59];
 ...
 */
export function useCopaAmericaTable(matches: IMatch[] = [], testMode = false, testHour?: number, selectedHours?: number[]): ITimeTable {
  return useMemo(() => {
