 ...
 * Implementa atualização silenciosa a cada 11 segundos igual ao comportamento da Euro League
 */
export const useItalianMatchData = () => {
  ...
  // Constantes
  const POLLING_INTERVAL = 11000; // 11 segundos (exatamente como na Euro League)
