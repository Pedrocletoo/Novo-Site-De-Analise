...
const COPA_ESTRELAS_API_URL = 'https://easy-api-betano-fv.u6y5np.easypanel.host/api.php?liga=copa-das-estrelas&result=480';
 ...
 * Implementa atualização silenciosa a cada 6 segundos igual ao comportamento das outras ligas
 */
